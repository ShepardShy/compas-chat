...
<script setup lang="ts">
	...
	const voiceMessageLengthTransformer = () => {
		...
		const messageDurationSeconds: number = currentCallNumber.value > 0 ? +(currentCallNumber.value * speedToCallFunction).toFixed(0) : +audioDuration.value.toFixed(0);
