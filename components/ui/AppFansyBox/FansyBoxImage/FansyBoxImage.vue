<template>
	<div
		class="fancybox-item fancybox__item"
		@mouseover="event => checkingBlock(event)"
	>
		<a
			class="fancybox-item__link"
			:data-fancybox="`galleryClick_${props.id}`"
			:href="setHref"
		>
...
<script setup>
	...
	import LoaderProgress from "~/components/ui/AppIcons/LoaderProgress/LoaderProgress.vue";
