<template>
	...
	>
		...
		<div
			v-if="props.isOneFile && props.isReadOnly && values.length > 1"
...
<script setup>
	...
	import FileUpload from "~/components/ui/AppInputs/File/FileUpload/FileUpload.vue";
	...
	const setClasses = computed(() => {
		return [values.value.length === 1 && props.isReadOnly ? "file-container_empty" : "", props.isOneFile ? "file-container_one-file" : ""];
	});
