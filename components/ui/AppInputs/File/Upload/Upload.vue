<template>
	...
	>
		...
		<div
			v-if="!props.isIcon || [null, undefined].includes(props.buttonIcon) || [null, undefined].includes(props.buttonIcon.file) || props.buttonIcon.file == ''"
		...
		<div
			v-else-if="props.isIcon && ![null, undefined].includes(props.buttonIcon) && ![null, undefined].includes(props.buttonIcon.file) && props.buttonIcon.file != ''"
