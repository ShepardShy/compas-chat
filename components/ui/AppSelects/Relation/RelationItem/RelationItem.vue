			...
			<figure
				...
				@click="
					event => {
						...
						callAction({ action: 'openLink', value: localItem });
					}
				"
			>
				<img
...
<script setup>
	...
	import AppAutocomplete from "~/components/ui/AppAutocomplete/Input/Input.vue";
	...
	const emit = defineEmits(["openLink", "callAction", "createOption", "clickOutside"]);
