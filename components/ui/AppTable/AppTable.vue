<template>
	...
	>
		...
		>
			...
			>
				<TableHeader :is-trash="props.isTrash" />
				<TableBody
					:slug="props.slug"
					:is-trash="props.isTrash"
					@call-action="data => callAction(data)"
		...
		<TableFooter @call-action="data => callAction(data)" />
		...
		<TableWarning @call-action="data => callAction(data)" />
	</AppSection>
</template>
...
<script setup>
	...
	import AppSection from "~/components/ui/AppSection/AppSection.vue";
	import SectionActions from "~/components/ui/AppSection/Actions/Actions.vue";
